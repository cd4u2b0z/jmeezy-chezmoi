...
"The sky speaks. I merely translate. With commentary."

A philosophical weather dashboard with the wisdom of ages,
the deadpan delivery of British comedy, and references
to lands both wasteland and fantastical.
...
def dashboard_main(screen: Screen):
    ...
    while True:
        ...
        if ev in (ord('a'), ord('A')):
            ...
            # Redraw dashboard after returning
            dashboard.draw()
        ...
        # Location search - press S or / to search any city
        if ev in (ord('s'), ord('S'), ord('/')):
